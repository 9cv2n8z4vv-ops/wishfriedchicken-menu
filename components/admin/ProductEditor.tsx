...
export function ProductEditor({
  ...
  return (
    <section className="admin-card">
      ...
      {isEditing && !currentPrice && !existingOptions.length ? <div className="notice">Fiyat belirtilmemiş. Aşağıdan fiyat ekleyebilirsiniz.</div> : null}
            ...
            <div>
              {options.map((option, index) => (
                <div className="price-option-editor" key={option.key}>
                  <div className="field">
                    <label htmlFor={`option-label-${index}`}>Porsiyon etiketi</label>
                  ...
                  <div className="field">
                    <label htmlFor={`option-price-${index}`}>Fiyat (TL)</label>
